      ...
      footer={
        <div className="flex gap-3 pt-2">
          ...
          <Button
            ...
            disabled={isDeleting || confirmation !== ERROR_MESSAGES.ACCOUNT_DELETE_CONFIRMATION}
          >
      ...
      <form id="delete-account-form" onSubmit={onSubmit} className="space-y-4">
        <div className="space-y-2">
          ...
          <p className="text-sm text-muted-foreground">
            {t('modalDescription')} <span className="font-mono bg-muted px-1 rounded">{ERROR_MESSAGES.ACCOUNT_DELETE_CONFIRMATION}</span>
          </p>
        </div>
